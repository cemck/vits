...
def train_and_evaluate(rank, epoch, hps, nets, optims, schedulers, scaler, loaders, logger, writers):
  ...
  net_g.train()
  net_d.train()
  for batch_idx, (x, x_lengths, spec, spec_lengths, y, y_lengths, speakers, emotions) in tqdm(enumerate(train_loader)):
...
def evaluate(hps, generator, eval_loader, writer_eval):
    ...
    with torch.no_grad():
      for batch_idx, (x, x_lengths, spec, spec_lengths, y, y_lengths, speakers, emotions) in enumerate(eval_loader):
        ...
        emotions = emotions[:1]
        break
      y_hat, attn, mask, *_ = generator.module.infer(x, x_lengths, speakers, emotions, max_len=1000)
